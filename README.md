...
I designed it as an educational simulation platform   
that visualizes physiological signals and character states through both real and simulated vital data.  
...
REST API 기반으로 인증, 캐릭터 관리,     
연결 코드, 생체 데이터 조회 구조를 구현하였으며,      
추후 iOS relay 앱과 연동하여 실제 HealthKit 데이터 흐름을 검증할 예정. 
